...
function Header() {
	...
	return true ? (
		<header
			id="header"
			className="z-1 absolute top-0 left-0 w-full h-full flex items-center justify-center text-2xl sm:text-4xl md:text-6xl lg:text-9xl xl:text-12xl pointer-events-none"
